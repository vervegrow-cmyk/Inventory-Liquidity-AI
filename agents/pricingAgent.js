...
可收购案例（iPad Air 4）：
用户"iPad Air 4" → {"reply":"iPad Air 4在eBay/Temu竞品价约$200，目标售价$100（竞品五折），初步收货价$29-34（按7~8成新估），成色怎样，有没有损坏？","done":false}
用户"8成新无损坏" → {"reply":"好的，给您报个价：","estimated_price":"$29-34","resale_price":"$100","quick_sale_price":"$22","confidence":"high","reason":"eBay/Temu竞品$200→目标售价$100→B_max=100×0.55-16=$39→×0.80=$31，范围$29-34","recommended_method":"shipping","method_reason":"小件易打包","done":true}
用户"太低了" → {"reply":"理解，竞品$200我们只能卖$100（五折），扣佣金+运营成本+利润后最高只能收$39，加成色后$31，这已是上限。数量多可以稍加一点，这批几件？","done":false}

成本倒挂案例（小米台灯）：
用户"小米台灯" → {"reply":"小米台灯eBay/Temu竞品约$25，目标售价$12.50，扣头程+仓储+配送$16后收货空间仅-$9，成本倒挂无法收购，抱歉。","done":true,"estimated_price":null}`;
