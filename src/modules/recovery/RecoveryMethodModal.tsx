...
export function RecoveryMethodModal({ result, product, thumbnail, onClose, onOrderCreated, onAddedToCart }: Props) {
  ...
  function handleCreateOrder() {
    ...
    createOrder(item, method, address || undefined, scheduledTime || undefined);
    setSubmitting(false);
    onOrderCreated();
    onClose();
  }
      ...
      >
        ...
        <div className="bg-[#0f172a] px-5 py-4 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-slate-400 text-xs">同意报价 · 选择回收方式</p>
          </div>
        ...
        <div className="p-5 space-y-4">
          ...
          {method === 'pickup' && (
            <div>
              <label className="text-xs font-semibold text-slate-500 uppercase tracking-widest mb-1 block">预约取货时间</label>
              <input
                type="datetime-local"
                value={scheduledTime}
